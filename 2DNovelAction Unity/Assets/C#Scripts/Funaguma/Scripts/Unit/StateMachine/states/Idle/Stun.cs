...
namespace BlackRose
{
    public class Stun : Idle
    {
        ...
        public Stun(Rigidbody2D rigidbody2D,float stunTime, Vector2 knockbackDirection = new(), string animationKey = "Stun") : base(animationKey)
        {
            _stunTime = stunTime;
        ...
        public override bool Enter(IState previousState, IUnit parent)
        {
            ...
            _rigidbody2D.AddForce(_knockbackDirection * parent.Direction * 2f, ForceMode2D.Impulse); // Apply knockback force
            return true;
        }
