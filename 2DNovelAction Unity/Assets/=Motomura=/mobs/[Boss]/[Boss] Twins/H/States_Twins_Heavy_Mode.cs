namespace BlackRose
{
    public partial class Boss_Twins_Heavy_Mode
    {
        public enum States {
            ...
            DiagonalMove,// 対角移動
            BlastShot_Charge,// ブラストショット（溜め）
            BlastShot_Fire,// ブラストショット（発射）
            CounterBurst_Defense,//カウンターバースト（防御）
            CounterBurst_Counterattack,//カウンターバースト（反撃）
            Stan,// スタン
            Dead// 死亡
        }
        public enum Triggers //TODO 次回、トリガーの名前変更
        {
            none,
