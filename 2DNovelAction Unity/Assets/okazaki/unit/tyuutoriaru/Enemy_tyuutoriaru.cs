    ...
    public class Enemy_tyuutoriaru : UnitBase
    {
        ...
        protected override void RegisterStats()
        {
            ...
            var stunTrigger = new[]                                // スタンステートのトリガー
            {
                ...
                (Triggers.Died, States.dead),                      // 死亡で死へ 
                (Triggers.HalfHP, States.shockwave) ,
            };
            ...
            //  ビームソード接近
            var beamswordapproaching = new Idle().SetAnimeTrigger("beamswordapproaching").SetCancelableProgress(0);
            _stateMachine.AddState(States.beamswordapproaching, beamswordapproaching);
            // ビームソード攻撃
